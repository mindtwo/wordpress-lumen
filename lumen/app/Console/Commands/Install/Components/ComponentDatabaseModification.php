...
class ComponentDatabaseModification extends ComponentBase implements WpInstallComponentsInterface {
	...
	public function fire() {
		...
		$excecute_commands = [
			...
			"cd {$this->home_dir} && php wp-cli.phar option update siteurl \"http://wordpress-lumen.dev\"",
			"cd {$this->home_dir} && php wp-cli.phar option update home \"http://wordpress-lumen.dev\"",

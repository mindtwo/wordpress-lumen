...
class ComponentWpCli extends ComponentBase implements WpInstallComponentsInterface {
	...
	public function fire() {
		...
		$excecute_commands = [
			...
			"cd {$this->home_dir} && php wp-cli.phar post create --user=1 --post_type=page --post_title=\"$contact\" --post_name=\"$contact\" --post_status=publish",
			"cd {$this->home_dir} && php wp-cli.phar post create --user=1 --post_type=page --post_title=\"$landingpage\" --post_name=\"$landingpage\" --post_status=publish",
			"cd {$this->home_dir} && php wp-cli.phar post create --user=1 --post_type=page --post_title=\"$team\" --post_name=\"$team\" --post_status=publish",
			"cd {$this->home_dir} && php wp-cli.phar post create --user=1 --post_type=page --post_title=\"$imprint\" --post_name=\"$imprint\" --post_status=publish",
			"cd {$this->home_dir} && php wp-cli.phar post create --user=1 --post_type=page --post_title=\"$privacy\" --post_name=\"$privacy\" --post_status=publish",

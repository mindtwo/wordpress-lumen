...
!function(e,t,r){"use strict";function s(e){return e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function n(){var t;q=!1,K=e.devicePixelRatio,H={},j={},t=(K||1)*k.xQuant,k.uT||(k.maxX=Math.max(1.3,k.maxX),t=Math.min(t,k.maxX),w.DPR=t),O.width=Math.max(e.innerWidth||0,M.clientWidth),O.height=Math.max(e.innerHeight||0,M.clientHeight),O.vw=O.width/100,O.vh=O.height/100,O.em=w.getEmValue(),O.rem=O.em,h=k.lazyFactor/2,h=h*t+h,v=.1*t,p=.5+.2*t,d=.5+.25*t,g=t+1.3,(f=O.width>O.height)||(h*=.9),F&&(h*=.9)}function i(e,t,r){var s=t*Math.pow(e,2);return f||(s/=1.3),e+=s,e>r}function a(e){if(!e.getBoundingClientRect)return!0;var t,r,s,n,i=e.getBoundingClientRect();return!!((t=i.bottom)>=-9&&(n=i.top)<=O.height+9&&(r=i.right)>=-9&&(s=i.left)<=O.height+9&&(t||r||s||n))}function c(e){var t,r=w.getSet(e),s=!1;"pending"!=r&&(s=!0,r&&(t=w.setRes(r),s=w.applySetCandidate(t,e))),e[w.ns].evaled=s}function l(e,t){return e.res-t.res}function u(e,t,r){var s;return!r&&t&&(r=e[w.ns].sets,r=r&&r[r.length-1]),s=o(t,r),s&&(t=w.makeUrl(t),e[w.ns].curSrc=t,e[w.ns].curCan=s,s.res||re(s,s.set.sizes)),s}function o(e,t){var r,s,n;if(e&&t)for(n=w.parseSet(t),e=w.makeUrl(e),r=0;r<n.length;r++)if(e==w.makeUrl(n[r].url)){s=n[r];break}return s}function m(e,t){var r,s,n,i,a=e.getElementsByTagName("source");for(r=0,s=a.length;s>r;r++)n=a[r],n[w.ns]=!0,i=n.getAttribute("srcset"),i&&t.push({srcset:i,media:n.getAttribute("media"),type:n.getAttribute("type"),sizes:n.getAttribute("sizes")})}t.createElement("picture");var p,d,f,h,g,v,x,y,S,w={},z=function(){},b=t.createElement("img"),E=b.getAttribute,T=b.setAttribute,R=b.removeAttribute,M=t.documentElement,C={},k={xQuant:1,lazyFactor:.4,maxX:2},L="data-risrc",$=L+"set",A="webkitBackfaceVisibility"in M.style,I=navigator.userAgent,U=/AppleWebKit/i.test(I),F=/rident/.test(I)||/ecko/.test(I)&&I.match(/rv\:(\d+)/)&&RegExp.$1>35,P=0,W="currentSrc",G=/\s+\+?\d+(e\d+)?w/,B=/((?:\([^)]+\)(?:\s*and\s*|\s*or\s*|\s*not\s*)?)+)?\s*(.+)/,D=/^([\+eE\d\.]+)(w|x)$/,N=/\s*\d+h\s*/,Q=e.respimgCFG,V=("https:"==location.protocol,"position:absolute;left:0;visibility:hidden;display:block;padding:0;border:none;font-size:1em;width:1em;overflow:hidden;clip:rect(0px, 0px, 0px, 0px)"),X="font-size:100%!important;",q=!0,H={},j={},K=e.devicePixelRatio,O={px:1,"in":96},_=t.createElement("a"),J=!1,Y=function(e,t,r,s){e.addEventListener?e.addEventListener(t,r,s||!1):e.attachEvent&&e.attachEvent("on"+t,r)},Z=function(e,t,r,s){e.removeEventListener?e.removeEventListener(t,r,s||!1):e.detachEvent&&e.detachEvent("on"+t,r)},ee=function(e){var t={};return function(r){return r in t||(t[r]=e(r)),t[r]}},te=function(){var e=/^([\d\.]+)(em|vw|px)$/,t=function(){for(var e=arguments,t=0,r=e[0];++t in e;)r=r.replace(e[t],e[++t]);return r},r=ee(function(e){return"return "+t((e||"").toLowerCase(),/\band\b/g,"&&",/,/g,"||",/min-([a-z-\s]+):/g,"e.$1>=",/max-([a-z-\s]+):/g,"e.$1<=",/calc([^)]+)/g,"($1)",/(\d+[\.]*[\d]*)([a-z]+)/g,"($1 * e.$2)",/^(?!(e.[a-z]|[0-9\.&=|><\+\-\*\(\)\/])).*/gi,"")});return function(t,s){var n;if(!(t in H))if(H[t]=!1,s&&(n=t.match(e)))H[t]=n[1]*O[n[2]];else try{H[t]=new Function("e",r(t))(O)}catch(i){}return H[t]}}(),re=function(e,t){return e.w?(e.cWidth=w.calcListLength(t||"100vw"),e.res=e.w/e.cWidth):e.res=e.x,e},se=function(e){var r,s,n,i=e||{};if(i.elements&&1==i.elements.nodeType&&("IMG"==i.elements.nodeName.toUpperCase()?i.elements=[i.elements]:(i.context=i.elements,i.elements=null)),r=i.elements||w.qsa(i.context||t,i.reevaluate||i.reparse?w.sel:w.selShort),n=r.length){for(w.setupRun(i),J=!0,s=0;n>s;s++)P++,6>P&&!r[s].complete&&P++,w.fillImg(r[s],i);w.teardownRun(i),P++}},ne=function(){var e=function(){Z(this,"load",e),Z(this,"error",e),w.fillImgs({elements:[this]})};return function(t){Z(t,"load",e),Z(t,"error",e),Y(t,"error",e),Y(t,"load",e)}}(),ie=ee(function(e){var t=[1,"x"],r=s(e||"");return r&&(r=r.replace(N,""),t=r.match(D)?[1*RegExp.$1,RegExp.$2]:!1),t});W in b||(W="src"),C["image/jpeg"]=!0,C["image/gif"]=!0,C["image/png"]=!0,C["image/svg+xml"]=t.implementation.hasFeature("http://wwwindow.w3.org/TR/SVG11/feature#Image","1.1"),w.ns=("ri"+(new Date).getTime()).substr(0,9),w.supSrcset="srcset"in b,w.supSizes="sizes"in b,w.selShort="picture>img,img[srcset]",w.sel=w.selShort,w.cfg=k,w.supSrcset&&(w.sel+=",img["+$+"]"),w.DPR=K||1,w.u=O,w.types=C,y=w.supSrcset&&!w.supSizes,w.setSize=z,w.makeUrl=ee(function(e){return _.href=e,_.href}),w.qsa=function(e,t){return e.querySelectorAll(t)},w.matchesMedia=function(){return w.matchesMedia=e.matchMedia&&(matchMedia("(min-width: 0.1em)")||{}).matches?function(e){return!e||matchMedia(e).matches}:w.mMQ,w.matchesMedia.apply(this,arguments)},w.mMQ=function(e){return e?te(e):!0},w.calcLength=function(e){var t=te(e,!0)||!1;return 0>t&&(t=!1),t},w.supportsType=function(e){return e?C[e]:!0},w.parseSize=ee(function(e){var t=(e||"").match(B);return{media:t&&t[1],length:t&&t[2]}}),w.parseSet=function(e){if(!e.cands){var t,r,s,n,i,a,c=e.srcset;for(e.cands=[];c;)c=c.replace(/^\s+/g,""),t=c.search(/\s/g),s=null,-1!=t?(r=c.slice(0,t),n=r.charAt(r.length-1),","!=n&&r||(r=r.replace(/,+$/,""),s=""),c=c.slice(t+1),null==s&&(i=c.indexOf(","),-1!=i?(s=c.slice(0,i),c=c.slice(i+1)):(s=c,c=""))):(r=c,c=""),r&&(s=ie(s))&&(a={url:r.replace(/^,+/,""),set:e},a[s[1]]=s[0],"x"==s[1]&&1==s[0]&&(e.has1x=!0),e.cands.push(a))}return e.cands},w.getEmValue=function(){var e;if(!x&&(e=t.body)){var r=t.createElement("div"),s=M.style.cssText,n=e.style.cssText;r.style.cssText=V,M.style.cssText=X,e.style.cssText=X,e.appendChild(r),x=r.offsetWidth,e.removeChild(r),x=parseFloat(x,10),M.style.cssText=s,e.style.cssText=n}return x||16},w.calcListLength=function(e){if(!(e in j)||k.uT){var t,r,n,i,a,c,l=s(e).split(/\s*,\s*/),u=!1;for(a=0,c=l.length;c>a&&(t=l[a],r=w.parseSize(t),n=r.length,i=r.media,!n||!w.matchesMedia(i)||(u=w.calcLength(n))===!1);a++);j[e]=u?u:O.width}return j[e]},w.setRes=function(e){var t;if(e){t=w.parseSet(e);for(var r=0,s=t.length;s>r;r++)re(t[r],e.sizes)}return t},w.setRes.res=re,w.applySetCandidate=function(e,t){if(e.length){var r,s,n,c,o,m,f,x,y,S,z,b,T,R=t[w.ns],M=!0,C=h,k=v;if(x=R.curSrc||t[W],y=R.curCan||u(t,x,e[0].set),s=w.DPR,T=y&&y.res,!f&&x&&(b=F&&!t.complete&&y&&T>s,b||y&&!(g>T)||(y&&s>T&&T>p&&(d>T&&(C*=.87,k+=.04*s),y.res+=C*Math.pow(T-k,2)),S=!R.pic||y&&y.set==e[0].set,y&&S&&y.res>=s?f=y:U||t.complete||!E.call(t,"src")||t.lazyload||F&&!(4>P)||!S&&a(t)||(f=y,z=x,M="L",ne(t)))),!f)for(T&&(y.res=y.res-(y.res-T)/2),e.sort(l),m=e.length,f=e[m-1],n=0;m>n;n++)if(r=e[n],r.res>=s){c=n-1,f=e[c]&&(o=r.res-s)&&(b||x!=w.makeUrl(r.url))&&i(e[c].res,o,s)?e[c]:r;break}return T&&(y.res=T),f&&(z=w.makeUrl(f.url),R.curSrc=z,R.curCan=f,z!=x&&w.setSrc(t,f),w.setSize(t)),M}},w.setSrc=function(e,t){var r;e.src=t.url,A&&(r=e.style.zoom,e.style.zoom="0.999",e.style.zoom=r)},w.getSet=function(e){var t,r,s,n=!1,i=e[w.ns].sets;for(t=0;t<i.length&&!n;t++)if(r=i[t],r.srcset&&w.matchesMedia(r.media)&&(s=w.supportsType(r.type))){"pending"==s&&(r=s),n=r;break}return n},w.parseSets=function(e,t,s){var n,i,a,c,l="PICTURE"==t.nodeName.toUpperCase(),u=e[w.ns];(u.src===r||s.src)&&(u.src=E.call(e,"src"),u.src?T.call(e,L,u.src):R.call(e,L)),(u.srcset===r||!w.supSrcset||e.srcset||s.srcset)&&(n=E.call(e,"srcset"),u.srcset=n,c=!0),u.sets=[],l&&(u.pic=!0,m(t,u.sets)),u.srcset?(i={srcset:u.srcset,sizes:E.call(e,"sizes")},u.sets.push(i),a=(y||u.src)&&G.test(u.srcset||""),a||!u.src||o(u.src,i)||i.has1x||(i.srcset+=", "+u.src,i.cands.push({url:u.src,x:1,set:i}))):u.src&&u.sets.push({srcset:u.src,sizes:null}),u.curCan=null,u.curSrc=r,u.supported=!(l||i&&!w.supSrcset||a),c&&w.supSrcset&&!u.supported&&(n?(T.call(e,$,n),e.srcset=""):R.call(e,$)),u.supported&&!u.srcset&&(!u.src&&e.src||e.src!=w.makeUrl(u.src))&&(null==u.src?e.removeAttribute("src"):e.src=u.src),u.parsed=!0},w.fillImg=function(e,t){var r,s,n=t.reparse||t.reevaluate;if(e[w.ns]||(e[w.ns]={}),s=e[w.ns],"L"==s.evaled&&e.complete&&(s.evaled=!1),n||!s.evaled){if(!s.parsed||t.reparse){if(r=e.parentNode,!r)return;w.parseSets(e,r,t)}s.supported?s.evaled=!0:c(e)}},w.setupRun=function(e){(!J||e.reevaluate||q)&&(n(),e.elements||e.context||clearTimeout(S))},e.HTMLPictureElement?(se=z,w.fillImg=z):!function(){var r,s=e.attachEvent?/d$|^c/:/d$|^c|^i/,n=function(){var e=t.readyState||"";c=setTimeout(n,"loading"==e?200:999),t.body&&(r=r||s.test(e),w.fillImgs(),r&&(P+=6,clearTimeout(c)))},i=function(){w.fillImgs({reevaluate:!0})},a=function(){clearTimeout(S),q=!0,S=setTimeout(i,99)},c=setTimeout(n,t.body?9:99);Y(e,"resize",a),Y(t,"readystatechange",n)}(),w.respimage=se,w.fillImgs=se,w.teardownRun=z,se._=w,e.respimage=se,e.respimgCFG={ri:w,push:function(e){var t=e.shift();"function"==typeof w[t]?w[t].apply(w,e):(k[t]=e[0],J&&w.fillImgs({reevaluate:!0}))}};for(;Q&&Q.length;)e.respimgCFG.push(Q.shift())}(window,document);
!function(e,t){var a=t(e,e.document);e.lazySizes=a,"object"==typeof module&&module.exports?module.exports=a:"function"==typeof define&&define.amd&&define(a)}(window,function(e,t){"use strict";if(t.getElementsByClassName){var a,i=t.documentElement,n=e.addEventListener,r=/^picture$/i,s=["load","error","lazyincluded","_lazyloaded"],o=function(e,t){var a=new RegExp("(\\s|^)"+t+"(\\s|$)");return e.className.match(a)&&a},l=function(e,t){o(e,t)||(e.className+=" "+t)},d=function(e,t){var a;(a=o(e,t))&&(e.className=e.className.replace(a," "))},c=function(e,t,a){var i=a?"addEventListener":"removeEventListener";a&&c(e,t),s.forEach(function(a){e[i](a,t)})},u=function(e,a,i,n,r){var s=t.createEvent("Event");return s.initEvent(a,!n,!r),s.details=i||{},e.dispatchEvent(s),s},f=function(t,i){var n;e.HTMLPictureElement||((n=e.picturefill||e.respimage||a.pf)?n({reevaluate:!0,reparse:!0,elements:[t]}):i&&i.src&&(t.src=i.src))},m=function(e,t){return getComputedStyle(e,null)[t]},g=function(e,t){for(var i=e.offsetWidth;i<a.minSize&&t&&!e._lazysizesWidth;)i=t.offsetWidth,t=t.parentNode;return i},v=function(e){var a,i,n=function(){a&&(a=!1,e())},r=function(){clearInterval(i),t.hidden||(n(),i=setInterval(n,51))};return t.addEventListener("visibilitychange",r),r(),function(e){a=!0,e===!0&&n()}},z=function(){var s,g,z,p,b,h,A,C,E,N,M,L,_,w=/^img$/i,S=/^iframe$/i,x="onscroll"in e&&!/glebot/.test(navigator.userAgent),T=0,B=0,W=0,R=0,D=0,O=function(e){R--,e&&e.target&&c(e.target,O),(!e||0>R||!e.target)&&(R=0)},P=function(e,t){var a,i=e,n="hidden"!=m(e,"visibility");for(C-=t,M+=t,E-=t,N+=t;n&&(i=i.offsetParent);)n=z&&2>R||(m(i,"opacity")||1)>0,n&&"visible"!=m(i,"overflow")&&(a=i.getBoundingClientRect(),n=N>a.left&&E<a.right&&M>a.top-1&&C<a.bottom+1);return n},$=function(){var e,t,i,n,r,o,l,d,c,u=s.length;if(u&&(b=a.loadMode)){for(t=Date.now(),e=D,W++,_>B&&1>R&&W>5&&b>2?(B=_,W=0):B=B!=L&&b>1&&W>4?L:T;u>e;e++,D++)if(s[e]&&!s[e]._lazyRace)if(x){if((d=s[e].getAttribute("data-expand"))&&(o=1*d)||(o=B),!(R>6&&(!d||"src"in s[e])))if(o>T&&(2>b||R>3)&&(o=T),c!==o&&(h=innerWidth+o,A=innerHeight+o,l=-1*o,c=o),i=s[e].getBoundingClientRect(),(M=i.bottom)>=l&&(C=i.top)<=A&&(N=i.right)>=l&&(E=i.left)<=h&&(M||N||E||C)&&(z&&_>B&&3>R&&4>W&&!d&&b>2||P(s[e],o)))D--,t+=2,H(s[e]),r=!0;else{if(Date.now()-t>3)return D++,void I();!r&&z&&!n&&3>R&&4>W&&b>2&&(g[0]||a.preloadAfterLoad)&&(g[0]||!d&&(M||N||E||C||"auto"!=s[e].getAttribute(a.sizesAttr)))&&(n=g[0]||s[e])}}else H(s[e]);D=0,n&&!r&&H(n)}},I=v($),k=function(e){l(e.target,a.loadedClass),d(e.target,a.loadingClass),c(e.target,k)},F=function(e,t){try{e.contentWindow.location.replace(t)}catch(a){e.setAttribute("src",t)}},H=function(e,t){var i,n,s,m,g,v,b,h,A,C,E,N=e.currentSrc||e.src,M=w.test(e.nodeName),L=e.getAttribute(a.sizesAttr)||e.getAttribute("sizes"),_="auto"==L;if(!_&&z||!M||!N||e.complete||o(e,a.errorClass)){if(e._lazyRace=!0,!(A=u(e,"lazybeforeunveil",{force:!!t})).defaultPrevented){if(L&&(_?y.updateElem(e,!0):e.setAttribute("sizes",L)),v=e.getAttribute(a.srcsetAttr),g=e.getAttribute(a.srcAttr),M&&(b=e.parentNode,h=r.test(b.nodeName||"")),C=A.details.firesLoad||"src"in e&&(v||g||h),C&&(R++,c(e,O,!0),clearTimeout(p),p=setTimeout(O,3e3)),h)for(i=b.getElementsByTagName("source"),n=0,s=i.length;s>n;n++)(E=a.customMedia[i[n].getAttribute("data-media")||i[n].getAttribute("media")])&&i[n].setAttribute("media",E),m=i[n].getAttribute(a.srcsetAttr),m&&i[n].setAttribute("srcset",m);v?e.setAttribute("srcset",v):g&&(S.test(e.nodeName)?F(e,g):e.setAttribute("src",g)),l(e,a.loadingClass),c(e,k,!0)}setTimeout(function(){e._lazyRace&&delete e._lazyRace,"auto"==L&&l(e,a.autosizesClass),(v||h)&&f(e,{src:g}),d(e,a.lazyClass),(!C||e.complete&&N==(e.currentSrc||e.src))&&(C&&O(A),k(A)),e=null})}},j=function(){var e,t=function(){a.loadMode=3,I()};z=!0,W+=8,a.loadMode=3,I(!0),n("scroll",function(){3==a.loadMode&&(a.loadMode=2),clearTimeout(e),e=setTimeout(t,66)},!0)};return{_:function(){s=t.getElementsByClassName(a.lazyClass),g=t.getElementsByClassName(a.lazyClass+" "+a.preloadClass),L=a.expand,_=L*a.expFactor,n("scroll",I,!0),n("resize",I,!0),e.MutationObserver?new MutationObserver(I).observe(i,{childList:!0,subtree:!0,attributes:!0}):(i.addEventListener("DOMNodeInserted",I,!0),i.addEventListener("DOMAttrModified",I,!0),setInterval(I,3e3)),n("hashchange",I,!0),["transitionstart","transitionend","load","focus","mouseover","animationend","click"].forEach(function(e){t.addEventListener(e,I,!0)}),(z=/d$|^c/.test(t.readyState))?j():(n("load",j),t.addEventListener("DOMContentLoaded",I)),I(s.length>0)},checkElems:I,unveil:H}}(),y=function(){var e,i=function(e,t){var a,i,n,s,o,l=e.parentNode;if(l&&(a=g(e,l),o=u(e,"lazybeforesizes",{width:a,dataAttr:!!t}),!o.defaultPrevented&&(a=o.details.width,a&&a!==e._lazysizesWidth))){if(e._lazysizesWidth=a,a+="px",e.setAttribute("sizes",a),r.test(l.nodeName||""))for(i=l.getElementsByTagName("source"),n=0,s=i.length;s>n;n++)i[n].setAttribute("sizes",a);o.details.dataAttr||f(e,o.details)}},s=function(){var t,a=e.length;if(a)for(t=0;a>t;t++)i(e[t])},o=v(s);return{_:function(){e=t.getElementsByClassName(a.autosizesClass),n("resize",o)},checkElems:o,updateElem:i}}(),p=function(){p.i||(p.i=!0,y._(),z._())};return function(){var t,i={lazyClass:"lazyload",loadedClass:"lazyloaded",loadingClass:"lazyloading",preloadClass:"lazypreload",errorClass:"lazyerror",autosizesClass:"lazyautosizes",srcAttr:"data-src",srcsetAttr:"data-srcset",sizesAttr:"data-sizes",minSize:50,customMedia:{},init:!0,expFactor:2,expand:300,loadMode:2};a=e.lazySizesConfig||{};for(t in i)t in a||(a[t]=i[t]);e.lazySizesConfig=a,setTimeout(function(){a.init&&p()})}(),{cfg:a,autoSizer:y,loader:z,init:p,uP:f,aC:l,rC:d,hC:o,fire:u,gW:g}}});
!function(e,t){"use strict";function r(e,r){if(!n[e]){var a=t.createElement(r?"link":"script"),o=t.getElementsByTagName("script")[0];r?(a.rel="stylesheet",a.href=e):a.src=e,n[e]=!0,n[a.src||a.href]=!0,o.parentNode.insertBefore(a,o)}}var a,n={};t.addEventListener&&e.getComputedStyle&&(a=function(e,r){var a=t.createElement("img");a.onload=function(){a.onload=null,a.onerror=null,a=null,r()},a.onerror=a.onload,a.src=e,a&&a.complete&&a.onload&&a.onload()},addEventListener("lazybeforeunveil",function(t){var n,o,i,l;t.defaultPrevented||("none"==t.target.preload&&(t.target.preload="auto"),n=t.target.getAttribute("data-link"),n&&r(n,!0),n=t.target.getAttribute("data-script"),n&&r(n),n=t.target.getAttribute("data-require"),n&&e.require&&require([n]),i=t.target.getAttribute("data-bg"),i&&(t.details.firesLoad=!0,o=function(){t.target.style.backgroundImage="url("+i+")",t.details.firesLoad=!1,lazySizes.fire(t.target,"_lazyloaded",{},!0,!0)},a(i,o)),l=t.target.getAttribute("data-poster"),l&&(t.details.firesLoad=!0,o=function(){t.target.poster=l,t.details.firesLoad=!1,lazySizes.fire(t.target,"_lazyloaded",{},!0,!0)},a(l,o)))},!1))}(window,document);
...
function initModalWindow(){1==window.modal_overlay&&(alertify.set({labels:{ok:"Schließen"}}),alertify.alert('<div class="alertify_modal_content">'+$(".modal_overlay").html()+"</div>"))}function initFancybox(){$(document).ready(function(){$(".fancybox").fancybox()})}function initLocalScroll(){$.localScroll({hash:!0,offset:{top:-155,left:0}})}function initlazySizesAfterEvent(){$(document).on("lazybeforeunveil",function(){var n=function(n){};return function(i){i.isDefaultPrevented()||$(i.target).filter("img").on("load",n)}}()),jQuery(window).on("resize orientationchange blur focus",function(){})}function initlazySizes(){initlazySizesAfterEvent(),window.lazySizesConfig=window.lazySizesConfig||{},window.lazySizesConfig.customMedia={"--small":"(max-width: 480px)","--large":"(min-width: 800px)"},lazySizes.init()}function initHashNav(){function n(n){$("#menu-hauptmenue li").removeClass("current-menu-item current_page_item active"),$('#menu-hauptmenue li:has(a[href="'+n+'"])').addClass("current-menu-item current_page_item active")}""!=location.hash&&n("/"+location.hash),$("#menu-hauptmenue a").click(function(){var i=$(this).attr("href");i.indexOf("#")>=0&&n(i)})}function initCustomForms(){function n(n,i){console.log(n.attr("data-captcha-image-path")),i.find(".captcha_image").css("background-image","url("+n.attr("data-captcha-image-path")+Math.floor(9999999999*Math.random())+")")}jQuery("input, textarea").placeholder(),jcf.replaceAll(),$("form").each(function(){var i=$(this).find("[data-captcha-image-path]"),a=$(this).find(".captcha-frame");a.find("a").click(function(t){console.log(i),console.log(a),n(i,a),t.preventDefault()})})}function initPreloader(){$(window).load(function(){$("#preloader").delay(350).fadeOut(300)})}jQuery(function(){initLocalScroll(),initlazySizes(),initModalWindow(),initFancybox(),initPreloader()});